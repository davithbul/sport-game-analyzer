...
public class MongoJobInstanceDao extends AbstractMongoDao implements JobInstanceDao {
  ...
  protected static String getJobInstanceCollectionName() {
      return "batchJobInstance";
  }

  protected String getCollectionName() {
    return getJobInstanceCollectionName();
  }
  ...
  public JobInstance createJobInstance(String jobName, final JobParameters jobParameters) {
    ...
    Long jobId = getNextId(getCollectionName(), mongoTemplate);
  ...
  public JobInstance getJobInstance(JobExecution jobExecution) {
    DBObject instanceId = mongoTemplate.getCollection(MongoJobExecutionDao.getJobExecutionCollectionName()).findOne(jobExecutionIdObj(jobExecution.getId()), jobInstanceIdObj(1L));
